...
I believe that an important aspect of presenting this history is to provide a snapshot of the psychology of game development in 1980 as no one reading this history will be able to comprehend how primitive and difficult it was for some people without deep financial pockets or a sugar-Daddy institution to provide the hardware & software. I can't even believe that I wrote a 2000 line BASEX program entirely on paper and without any coding/debugging/editing environment to support the work. But for perspective, I didn't know any better at the time since having a personal computer was by itself a gift. Coding in BASEX was like writing software in Neanderthal times. I'm sure that many other Apple-II, TRS-80, PET and VIC-20 computer developers of 1980 experienced similar challenges. 

In 1980 I only had a 16k Exidy Sorcerer computer with a tape cassette for saving and loading files at 1200 baud. The machine would often lock-up due to its known heat issues and/or the files saved to tape would have become corrupted (this is why I still actively do daily backups of all my computer work). I did not have a disk system running CP/M nor was the Wordstar editor (my favourite and current programming editor) available to me. I had no access to any 8080/Z80 assembler or editor due the real, financial constraints I justify further below. I basically had nothing available to me for programming - no compilers and no text editors. There was only 8k Exidy BASIC in the ROM pack, BASEX, and pen + paper. I was not alone as my personal friends were in the same boat. At that point in time it was common to code up your assembly-based programs on paper since it was faster, more reliable and that code could be read 40 years again in the future with ease. 
...
Others, who have recently read my comments above, have argued that "this was not the case" as they had access to machines in the late 1970s that had assemblers, high-level compilers, text editors and 300 baud modem access to their local universities. That may have been the case but such individuals were either (1) well off financially, (2) hobbyists that had a good job, (3) were working for a business that could afford such computers and/or (4) were associated with an institution that provided the hardware and software to them. I would like to put their comments and mine into a dual perspective for consideration based on the realitstic and actual 1979-era financial cost:

- It cost me $1706 (in my local currency, 1979 dollars) to acquire my 1979-era Exidy Sorcerer with 16k ($1152), 32k of expansion memory ($150), Sears cassette tape recorder ($75), monitor ($200) and acoustic coupler modem ($129).  In current dollars that would be **$7336**. As a very young student this took me years to pay down the loan as it was not a freebie to me. For comparison, one year of university cost $1300 (without books), the MSRP price of a Ford Pinto in 1979 was ~$4490 (in my local currency) and the median average family income in my country was $24,000. 
